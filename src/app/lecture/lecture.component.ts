...
export class LectureComponent implements OnInit {
  lectureList = [
    ...
    { route: 'foxrabbit1', label: 'Phần 1: Trò chơi của cáo và thỏ' },
    { route: 'foxrabbit2', label: 'Phần 2: Trò chơi của thỏ và cáo: Thực chiến' },
    { route: 'foxrabbit3', label: 'Phần 3: Trò chơi của cáo và thỏ: Ai được, ai mất?' },
    { route: 'cotan1', label: 'Đánh cờ tàn' },
  ];
